    ...
    <>
      ...
      <div className="container mx-auto py-24">
        <p className="text-lg mb-8">
          Welcome to evantA, your one-stop platform for hosting and attending events. We make the process seamless and fun.
        </p>

        <p className="text-lg mb-8">
          At evantA, we provide tools for browsing events, booking tickets, and hosting your own, with full customization options.
        </p>
