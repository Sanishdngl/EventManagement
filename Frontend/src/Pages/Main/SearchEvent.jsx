...
const SearchEvent = () => {
  return (
    <>
      ...
      <div className="flex justify-evenly">
        <Link to="/educational-events">
          <div className="card bg-base-100 w-96 shadow-xl object-cover transition-transform transform hover:scale-110 hover:shadow-lg cursor-pointer">
            <div className="card-body">
